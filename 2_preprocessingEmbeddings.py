...
embeddingFile = "C:/Users/nanim/Downloads/attendence Recognition-20240714T145610Z-001/attendence Recognition/code/output/embeddings.pickle" #initial name for embedding file
embeddingModel = "C:/Users/nanim/Downloads/attendence Recognition-20240714T145610Z-001/attendence Recognition/code/openface_nn4.small2.v1.t7" #initializing model for embedding Pytorch

#initialization of caffe model for face detection
prototxt = "C:/Users/nanim/Downloads/attendence Recognition-20240714T145610Z-001/attendence Recognition/code/model/deploy.prototxt"
model =  "C:/Users/nanim/Downloads/attendence Recognition-20240714T145610Z-001/attendence Recognition/code/model/res10_300x300_ssd_iter_140000.caffemodel"

# Check if the files exist
if not os.path.isfile(prototxt):
    raise FileNotFoundError(f"File {prototxt} not found")

if not os.path.isfile(model):
    raise FileNotFoundError(f"File {model} not found")
